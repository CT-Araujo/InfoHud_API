...
class Postagens(models.Model):
    ...
    subtitulo = models.CharField(max_length=140, blank= False, null= False)
    categoria = models.CharField(max_length=50, blank= False, null= True)
    miniurl = models.CharField(max_length=400, blank= True, null=True)
    conteudo = models.CharField(max_length=4000, blank=False, null=True)
